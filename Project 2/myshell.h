...
// search_path.c - search and update shell commands
extern char *search_path(char *, char *);
extern void update_shellcmd(SHELLCMD *, char *);

// execute_command.c - execute shell command arguments
extern int execute_command(SHELLCMD *);

// internal_command.c - run internal functions
extern void run_exit(SHELLCMD *);
extern int run_cd(SHELLCMD *);
extern int run_time(SHELLCMD *);

// subshell.c - spawn subshell
extern int create_subshell(SHELLCMD *);

// file_redirection - redirect i/o
extern void check_redirects(SHELLCMD *);

// pipeline.c - open pipelines between shell commands
extern int open_pipeline(SHELLCMD *, SHELLCMD *);

// shell_script.c - check existence of shell script
extern int check_shellscript(SHELLCMD *t);

// background.c - run shell command in the background
extern int run_background(SHELLCMD *);
